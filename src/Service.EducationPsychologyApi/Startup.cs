...
using Service.EducationPsychologyApi.Modules;
using Service.Web;
using SimpleTrading.ServiceStatusReporterConnector;

namespace Service.EducationPsychologyApi
{
	public class Startup
	{
		private const string DocumentName = "education/psychology";
		private const string ApiName = "EducationPsychologyApi";
