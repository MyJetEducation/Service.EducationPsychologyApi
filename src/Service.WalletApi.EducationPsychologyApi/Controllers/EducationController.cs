...
using Service.WalletApi.EducationPsychologyApi.Controllers.Contracts;
using Service.WalletApi.EducationPsychologyApi.Mappers;
using Service.Web;

namespace Service.WalletApi.EducationPsychologyApi.Controllers
{
	[Route("/api/v1/education/psychology")]
	public class EducationController : BaseController
	{
		private readonly IGrpcServiceProxy<ITutorialPsychologyService> _tutorialService;

		public EducationController(IGrpcServiceProxy<ITutorialPsychologyService> tutorialService,
