...
using Service.WalletApi.EducationPsychologyApi.Modules;

namespace Service.WalletApi.EducationPsychologyApi
{
	public class Startup
	{
		...
		{
			StartupUtils.SetupWalletApplication(app, env, Program.Settings.EnableApiTrace, "education/psychology");
